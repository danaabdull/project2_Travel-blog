...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 26, 2024 at 08:01 PM
...
CREATE TABLE `blogs` (
  ...
  `Blog_Type` enum('الترفيهية','الثقافية','الدينية','الشاطئية','التأمل','المغامرات') DEFAULT NULL,
...
CREATE TABLE `monuments_important` (
  ...
  `Monuments_Important_Name` varchar(255) DEFAULT NULL,
  `Monuments_Important_Description` text DEFAULT NULL,
  `Monuments_Important_Type` enum('الترفيهية','الثقافية','الدينية','الشاطئية','التأمل','المغامرات') DEFAULT NULL,
  `Monuments_Important_Location` varchar(255) DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `User_National` varchar(255) DEFAULT NULL,
...
(1, 'rawabi', 'r@22.com', '123', 56456456, '2018-10-05', 'سعودي', 'المدينة '),
